...
public class RoleService {
    ...
    @AuditLog(moduleName="角色", operationType="")
    ...
    public int insertRole(JSONObject obj, HttpServletRequest request)throws Exception {
        ...
        try{
            ...
            AuditLogContext.setContent(BusinessConstants.LOG_OPERATION_TYPE_ADD + role.getName());
        }catch(Exception e){
    ...
    public int updateRole(JSONObject obj, HttpServletRequest request) throws Exception{
        ...
        try{
            ...
            AuditLogContext.setContent(BusinessConstants.LOG_OPERATION_TYPE_EDIT + role.getName());
        }catch(Exception e){
            JshException.writeFail(logger, e);
        }
        return result;
    ...
    @AuditLog(moduleName="角色", operationType="更新状态")
    @Transactional(value = "transactionManager", rollbackFor = Exception.class)
