...
public class DepotService {
    ...
    @AuditLog(module="仓库", operation=OperationType.ADD)
    ...
    public int insertDepot(JSONObject obj, HttpServletRequest request)throws Exception {
        ...
        try{
            ...
            AuditContextHolder.setContentDetail(depot.getName());
        }catch(Exception e){
    ...
    @AuditLog(module="仓库", operation=OperationType.EDIT)
    @Transactional(value = "transactionManager", rollbackFor = Exception.class)
    ...
    @AuditLog(module="仓库", operation=OperationType.DELETE)
    @Transactional(value = "transactionManager", rollbackFor = Exception.class)
    ...
    public int updateIsDefault(Long depotId) throws Exception{
        ...
        try{
            ...
            AuditContextHolder.setContentDetail(String.valueOf(depotId));
            result = 1;
        }catch(Exception e){
            JshException.writeFail(logger, e);
        }
    ...
    @AuditLog(module="仓库", operation=OperationType.ENABLED)
    @Transactional(value = "transactionManager", rollbackFor = Exception.class)
