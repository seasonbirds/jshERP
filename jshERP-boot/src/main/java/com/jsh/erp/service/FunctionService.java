...
public class FunctionService {
    ...
    @AuditLog(module="功能", operation=OperationType.ADD)
    ...
    public int insertFunction(JSONObject obj, HttpServletRequest request)throws Exception {
        ...
        try{
            if(BusinessConstants.DEFAULT_MANAGER.equals(userService.getCurrentUser().getLoginName())) {
                ...
                AuditContextHolder.setContentDetail(functions.getName());
            }
        }catch(Exception e){
    ...
    @AuditLog(module="功能", operation=OperationType.EDIT)
    @Transactional(value = "transactionManager", rollbackFor = Exception.class)
    ...
    @AuditLog(module="功能", operation=OperationType.DELETE)
    @Transactional(value = "transactionManager", rollbackFor = Exception.class)
