...
public class MsgService {
    ...
    @AuditLog(module="消息", operation=OperationType.ADD)
    ...
    public int insertMsg(JSONObject obj, HttpServletRequest request)throws Exception {
        ...
        try{
            ...
            if(!BusinessConstants.DEFAULT_MANAGER.equals(userInfo.getLoginName())) {
                ...
                AuditContextHolder.setContentDetail(msg.getMsgTitle());
            }
        }catch(Exception e){
            logger.error("异常码[{}],异常提示[{}],异常[{}]",
    ...
    @AuditLog(module="消息", operation=OperationType.EDIT)
    @Transactional(value = "transactionManager", rollbackFor = Exception.class)
    ...
    @AuditLog(module="消息", operation=OperationType.DELETE)
    @Transactional(value = "transactionManager", rollbackFor = Exception.class)
    ...
    @AuditLog(module="消息", operation=OperationType.CUSTOM)
    @Transactional(value = "transactionManager", rollbackFor = Exception.class)
