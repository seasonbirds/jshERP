...
public class InOutItemService {
    ...
    @AuditLog(module="收支项目", operation=OperationType.ADD)
    ...
    public int insertInOutItem(JSONObject obj, HttpServletRequest request)throws Exception {
        ...
        try{
            ...
            AuditContextHolder.setContentDetail(inOutItem.getName());
        }catch(Exception e){
    ...
    @AuditLog(module="收支项目", operation=OperationType.EDIT)
    @Transactional(value = "transactionManager", rollbackFor = Exception.class)
    ...
    @AuditLog(module="收支项目", operation=OperationType.DELETE)
    @Transactional(value = "transactionManager", rollbackFor = Exception.class)
    ...
    @AuditLog(module="收支项目", operation=OperationType.ENABLED)
    @Transactional(value = "transactionManager", rollbackFor = Exception.class)
