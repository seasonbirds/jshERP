...
public class AccountService {
    ...
    @OperationLog(moduleName="账户", operationType=OperationType.ADD)
    ...
    public int insertAccount(JSONObject obj, HttpServletRequest request)throws Exception {
        ...
        try{
            ...
            LogContentProvider.setContent("新增" + account.getName());
        }catch(Exception e){
    ...
    @OperationLog(moduleName="账户", operationType=OperationType.EDIT)
    @Transactional(value = "transactionManager", rollbackFor = Exception.class)
    public int updateAccount(JSONObject obj, HttpServletRequest request)throws Exception {
        ...
        try{
            ...
            LogContentProvider.setContent("修改" + account.getName());
        }catch(Exception e){
            JshException.writeFail(logger, e);
        }
        return result;
    ...
    @OperationLog(moduleName="账户", operationType=OperationType.DELETE)
    @Transactional(value = "transactionManager", rollbackFor = Exception.class)
    ...
    public int updateIsDefault(Long accountId) throws Exception{
        ...
        try{
            ...
            LogContentProvider.setContent(BusinessConstants.LOG_OPERATION_TYPE_EDIT + accountId);
            result = 1;
        }catch(Exception e){
            JshException.writeFail(logger, e);
        }
    ...
    @OperationLog(moduleName="账户", operationType=OperationType.ENABLED)
    @Transactional(value = "transactionManager", rollbackFor = Exception.class)
