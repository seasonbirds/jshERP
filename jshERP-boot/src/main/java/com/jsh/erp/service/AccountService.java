...
public class AccountService {
    ...
    @AuditLog(module="账户", operation=OperationType.ADD)
    ...
    public int insertAccount(JSONObject obj, HttpServletRequest request)throws Exception {
        ...
        try{
            ...
            AuditContextHolder.setContentDetail(account.getName());
        }catch(Exception e){
    ...
    @AuditLog(module="账户", operation=OperationType.EDIT)
    @Transactional(value = "transactionManager", rollbackFor = Exception.class)
    ...
    @AuditLog(module="账户", operation=OperationType.DELETE)
    @Transactional(value = "transactionManager", rollbackFor = Exception.class)
    ...
    public int updateIsDefault(Long accountId) throws Exception{
        ...
        try{
            ...
            AuditContextHolder.setContentDetail(String.valueOf(accountId));
            result = 1;
        }catch(Exception e){
            JshException.writeFail(logger, e);
        }
    ...
    @AuditLog(module="账户", operation=OperationType.ENABLED)
    @Transactional(value = "transactionManager", rollbackFor = Exception.class)
