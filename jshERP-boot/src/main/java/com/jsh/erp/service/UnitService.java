...
public class UnitService {
    ...
    @AuditLog(moduleName="多单位", operationType="")
    ...
    public int insertUnit(JSONObject obj, HttpServletRequest request)throws Exception {
        ...
        try{
            ...
            AuditLogContext.setContent(BusinessConstants.LOG_OPERATION_TYPE_ADD + unit.getName());
        }catch(Exception e){
    ...
    public int updateUnit(JSONObject obj, HttpServletRequest request)throws Exception {
        ...
        try{
            ...
            AuditLogContext.setContent(BusinessConstants.LOG_OPERATION_TYPE_EDIT + unit.getName());
        }catch(Exception e){
            JshException.writeFail(logger, e);
        }
        return result;
    ...
    @AuditLog(moduleName="多单位", operationType="更新状态")
    @Transactional(value = "transactionManager", rollbackFor = Exception.class)
