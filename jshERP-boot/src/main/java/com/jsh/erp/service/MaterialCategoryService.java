...
public class MaterialCategoryService {
    ...
    @AuditLog(module="商品类型", operation=OperationType.ADD)
    ...
    public int insertMaterialCategory(JSONObject obj, HttpServletRequest request)throws Exception {
        ...
        try{
            ...
            AuditContextHolder.setContentDetail(materialCategory.getName());
        }catch(Exception e){
    ...
    @AuditLog(module="商品类型", operation=OperationType.EDIT)
    @Transactional(value = "transactionManager", rollbackFor = Exception.class)
    ...
    @AuditLog(module="商品类型", operation=OperationType.DELETE)
    @Transactional(value = "transactionManager", rollbackFor = Exception.class)
