...
public class MaterialPropertyService {
    ...
    @BusinessLog(moduleName = "商品属性", type = LogType.ADD, contentTemplate = "{obj.nativeName}")
    ...
    @Transactional(value = "transactionManager", rollbackFor = Exception.class)
    @BusinessLog(moduleName = "商品属性", type = LogType.EDIT, contentTemplate = "{obj.nativeName}")
